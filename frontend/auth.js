...
class AuthManager {
  ...
  async handleSignIn(e) {
    ...
    try {
      ...
      this.showAlert("error", "Unable to connect to server. Ensure backend is running on http://localhost:5000");
    } finally {
  ...
  async handleSignUp(e) {
    ...
    try {
      ...
      this.showAlert("error", "Could not connect to backend server. Make sure server is running on port 5000.");
    } finally {
